$(document).ready(function () {
            ...
            if (alt_title == 'header') {
                ...
                if ((a > b || a==b) && nullCheck(areas)) {
                    ...
                    if(text_==''){
                            ...
                            alert( alertmsg+' is empty crop again')
                        }
                ...
                if (arrCount < a) {
                    ...
                    tr += '<img src="images/FT.png" class="extraCrps cropingFT" key="'+id+'" target="'+target+'" title="FEUD Training">'
                    tr += '</div>'
                    tr += '</div>'
    ...
    $("body").on("click", ".nextToTable", function () {
        ...
        if(empt___ == 0){
            if(nullCheck($(".optionss").val()) || retrain == 'yes') {
                ...
                // console.log(modifiedMainDataToSend)
                // new_fields_data = {}
                // fields_data = modifiedMainDataToSend['fields']
                // for (var key in fields_data){
                //     // if (fields_data['additional_splits']['type'] == 'FT'){
                //     if ("additional_splits" in fields_data[key]){
                //         if ("type" in fields_data[key]["additional_splits"]){
                //             if(fields_data[key].additional_splits.type == 'FT') {
                //                 new_fields_data[key] = fields_data[key]
                //             }
                //             else{
                //                 new_fields_data[key] = fields_data[key]
                //             }
                ...
                // }
                // modifiedMainDataToSend['fields'] = new_fields_data
    ...
    $("body").on("load", "#tableStep", function () {
        debugger;
       newTable();
    });

    function newTable(){
        console.log('new table running')
        tableCount = $(this).attr("count");
        $(this).attr("count", Number(tableCount)+1);
        ...
        if($.trim(template_name) != "") {
            ...
            if (procd == 1) {
                ...
                if(retrain == 'yes'){
                    ...
                    console.log(JSON.stringify(mainDataToSend));
                    var form = new FormData();
    ...
    // $("body").on("change", '.close-'+select_id+'-'+select_traget, function () {
    //     debugger
    //    console.log("done")
    ...
    //    alert($(this).val())
    // })
    // $(".close-"+select_id+'-'+select_traget).change(function(){
    //      debugger
    //    alert($(this).val())
    //    var key = $(this).val();
    //    console.log(key);
