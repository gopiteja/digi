! function(e, t) {
    ...
    return function(e) {
        ...
        var w = function() {
                ...
                return e.toRoman = function(e, t) {
                    ...
                    var r = document.createElement("script"),
                        n = !1;
                    r.setAttribute("src", e), t && (r.onload = function() {
                        n || t(), n = !0
            ...
            P = function() {
                function e(e, t, r, n, i, a) {
                    ...
                    var o, s, l, u, c, h, d, f, p = (e[2] + e[0]) / 2,
                        m = (e[3] + e[1]) / 2;
                    ...
                    a && (l = -l, u = -u), 0 === o ? (c = Math.abs(m - e[1]) * t + n, h = Math.abs(p - e[0]) * t + i, d = Math.abs(e[3] - e[1]) * t, f = Math.abs(e[2] - e[0]) * t) : (c = Math.abs(p - e[0]) * t + n, h = Math.abs(m - e[1]) * t + i, d = Math.abs(e[2] - e[0]) * t, f = Math.abs(e[3] - e[1]) * t), this.transform = [o * t, s * t, l * t, u * t, c - o * t * p - l * t * m, h - s * t * p - u * t * m], this.width = d, this.height = f, this.fontScale = t
                }
                return e.prototype = {
                    clone: function(t) {
        ...
        var R, x = function(e, t) {
            ...
            T = (R = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", function(e, t) {
                ...
                for (var n = "data:" + t + ";base64,", i = 0, a = e.length; i < a; i += 3) {
                    var o = 255 & e[i],
                        s = 255 & e[i + 1],
                        l = 255 & e[i + 2];
                    n += R[o >> 2] + R[(3 & o) << 4 | s >> 4] + R[i + 1 < a ? (15 & s) << 2 | l >> 6 : 64] + R[i + 2 < a ? 63 & l : 64]
                }
                return n
            });
        ...
        function F(e, t, r) {
            ...
            this._onComObjOnMessage = function(e) {
                ...
                if (t.targetName === n.sourceName)
                    ...
                    var s = i[o];
                    delete i[o], "error" in t ? s.reject(O(t.error)) : s.resolve(t.data)
                } else {
                    ...
                    if (t.callbackId) {
                        ...
                        Promise.resolve().then(function() {
                            ...
                            r.postMessage({
                                ...
                                callbackId: t.callbackId,
                                error: function(e) {
                                    return !(e instanceof Error) || e instanceof b || e instanceof f || e instanceof p || e instanceof h ? e : new h(e.message, e.toString())
                                }(e)
                            })
                        })
                    } else t.streamId ? n._createStreamSink(t) : l[0].call(l[1], t.data)
                }
        ...
        F.prototype = {
            ...
            _createStreamSink: function(e) {
                    ...
                    u = {
                        enqueue: function(e) {
                            ...
                            if (!this.isCancelled) {
                                ...
                                this.desiredSize -= t, n > 0 && this.desiredSize <= 0 && (this.sinkCapability = k(), this.ready = this.sinkCapability.promise), l({
                                    stream: "enqueue",
                                    chunk: e,
                                    transfers: r
                                })
                        ...
                        close: function() {
                            this.isCancelled || (this.isCancelled = !0, l({
                                stream: "close"
                ...
                u.sinkCapability.resolve(), u.ready = u.sinkCapability.promise, this.streamSinks[i] = u, E(n[0], [e.data, u], n[1]).then(function() {
                    l({
            ...
            _processStreamMessage: function(e) {
                ...
                switch (e.stream) {
                    case "start_complete":
                        I(this.streamControllers[e.streamId].startCall, e.success, O(e.reason));
                        break;
                    case "pull_complete":
                        I(this.streamControllers[e.streamId].pullCall, e.success, O(e.reason));
                        break;
                    case "pull":
                        ...
                        this.streamSinks[e.streamId].desiredSize <= 0 && e.desiredSize > 0 && this.streamSinks[e.streamId].sinkCapability.resolve(), this.streamSinks[e.streamId].desiredSize = e.desiredSize, E(this.streamSinks[e.streamId].onPull).then(function() {
                            a({
                                stream: "pull_complete",
                                success: !0
                            })
                    ...
                    case "close":
                        ...
                        break;
                    case "error":
                        u(this.streamControllers[e.streamId], "error should have stream controller"), this.streamControllers[e.streamId].controller.error(O(e.reason)), o();
                        break;
                    case "cancel_complete":
                        I(this.streamControllers[e.streamId].cancelCall, e.success, O(e.reason)), o();
                        break;
                    case "cancel":
                        if (!this.streamSinks[e.streamId]) break;
                        E(this.streamSinks[e.streamId].onCancel, [O(e.reason)]).then(function() {
                            a({
                        ...
                        }), this.streamSinks[e.streamId].sinkCapability.reject(O(e.reason)), this.streamSinks[e.streamId].isCancelled = !0, delete this.streamSinks[e.streamId];
                        break;
                    default:
            ...
            constructPath: 91
        }, t.VerbosityLevel = a, t.UNSUPPORTED_FEATURES = {
            unknown: "unknown",
            forms: "forms",
            ...
            BINARY: 1,
            STREAM: 2
        }, t.AbortException = b, t.InvalidPDFException = d, t.MessageHandler = F, t.MissingDataException = v, t.MissingPDFException = f, t.NativeImageDecoding = {
            NONE: "none",
            DECODE: "decode",
            DISPLAY: "display"
        }, t.NotImplementedException = m, t.PageViewport = P, t.PasswordException = c, t.PasswordResponses = {
            NEED_PASSWORD: 1,
            ...
            FILL_STROKE_MASK: 3,
            ADD_TO_PATH_FLAG: 4
        }, t.UnexpectedResponseException = p, t.UnknownErrorException = h, t.Util = w, t.XRefParseException = g, t.FormatError = _, t.arrayByteLength = S, t.arraysToBytes = function(e) {
            ...
            u(null !== e && "object" === (void 0 === e ? "undefined" : n(e)) && void 0 !== e.length, "Invalid argument for bytesToString");
            var t = e.length;
            ...
            return r.join("")
        }, t.createBlob = x, t.createPromiseCapability = k, t.createObjectURL = T, t.deprecated = function(e) {
            // console.log("Deprecated API usage: " + e)
        }, t.getInheritableProperty = function(e) {
            for (var t = e.dict, r = e.key, n = e.getArray, i = void 0 !== n && n, a = e.stopWhenFound, o = void 0 === a || a, l = 0, u = void 0; t;) {
                ...
                if (++l > 100) {
                    s('getInheritableProperty: maximum loop count exceeded for "' + r + '"');
                    break
                }
                t = t.get("Parent")
            }
            ...
            return "string" != typeof e ? (s("The argument for removeNullCharacters must be a string."), e) : e.replace(y, "")
        ...
        var n = r(4),
            ...
            l = function e(t, r, l) {
                ...
                for (u in p && (l = r), l) h = ((c = !f && g && void 0 !== g[u]) ? g : l)[u], d = v && c ? s(h, n) : m && "function" == typeof h ? s(Function.call, h) : h, g && o(g, u, h, t & e.U), _[u] != h && a(_, u, d), m && b[u] != h && (b[u] = h)
            };
        ...
        r(5).inspectSource = function(e) {
            ...
            u && (a(r, "name") || i(r, "name", t)), e[t] !== r && (u && (a(r, o) || i(r, o, e[t] ? "" + e[t] : l.join(String(t)))), e === n ? e[t] = r : s ? e[t] ? e[t] = r : i(e, t, r) : (delete e[t], i(e, t, r)))
            ...
            h = e.exports = function(e, t, r, h, d) {
                ...
                if (a(g)) {
                    for (f = s(e.length); f > b; b++)
                        if ((v = t ? _(o(p = e[b])[0], p[1]) : _(e[b])) === u || v === c) return v
                } else
                            ...
                            o.open("GET", a, !0), t.isCompressed && (o.responseType = "arraybuffer"), o.onreadystatechange = function() {
                                if (o.readyState === XMLHttpRequest.DONE) {
                                    if (200 === o.status || 0 === o.status) {
                                        var r = void 0;
                                        if (t.isCompressed && o.response ? r = new Uint8Array(o.response) : !t.isCompressed && o.responseText && (r = (0, i.stringToBytes)(o.responseText)), r) return void e({
                                            cMapData: r,
                                            compressionType: t.isCompressed ? i.CMapCompressionType.BINARY : i.CMapCompressionType.NONE
                                        })
                                    }
        ...
        var p = function() {
                ...
                return n(e, [{
                    ...
                    key: "timeEnd",
                    value: function(e) {
                        this.enabled && (e in this.started || (0, i.warn)("Timer has not been started for " + e), this.times.push({
                            name: e,
        ...
        t.RenderingCancelledException = h, t.addLinkAttributes = function(e) {
        ...
        }, t.LinkTarget = d, t.DEFAULT_LINK_REL = o, t.DOMCanvasFactory = l, t.DOMCMapReaderFactory = u, t.DOMSVGFactory = c, t.StatTimer = p, t.DummyStatTimer = m
    }, function(e, t, r) {
        "use strict";
        var n = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
            return typeof e
        ...
        var n = r(31),
            i = {};
        i[r(1)("toStringTag")] = "z", i + "" != "[object z]" && r(7)(Object.prototype, "toString", function() {
        ...
        e.exports = function(e, t, r, p, m, v, g) {
            ...
            if (T && (y = c(T.call(new e))) !== Object.prototype && y.next && (u(y, S, !0), n || "function" == typeof y[h] || o(y, h, f)), w && k && "values" !== k.name && (P = !0, R = function() {
                    return k.call(this)
                }), n && !g || !d && !P && C[h] || o(C, h, R), s[t] = R, s[S] = f, m)
                if (_ = {
                        values: w ? R : A("values"),
                        keys: v ? R : A("keys"),
                        entries: x
        ...
        "use strict";
        for (var n = r(85), i = r(21), a = r(7), o = r(4), s = r(10), l = r(17), u = r(1), c = u("iterator"), h = u("toStringTag"), d = l.Array, f = {
                CSSRuleList: !0,
        ...
        e.exports = function(e, t) {
            ...
            return function(t, s, p) {
                for (var m, v, g = a(t), _ = i(g), b = n(s, p, 3), y = o(_.length), A = 0, S = r ? f(t, y) : l ? f(t, 0) : void 0; y > A; A++)
        ...
        (a || s) && (n.disableCreateObjectURL = !0), (l || o) && (n.disableRange = !0, n.disableStream = !0);
        ...
        if (!i._pdfjsCompatibilityChecked) {
            ...
            !i.btoa && a() && (i.btoa = function(e) {
                ...
                }), String.prototype.includes || r(62), Array.prototype.includes || r(67), Math.log2 || (Math.log2 = r(70)), Number.isNaN || (Number.isNaN = r(72)), Number.isInteger || (Number.isInteger = r(74)), i.Promise || (i.Promise = r(77)), i.WeakMap || (i.WeakMap = r(96)),
                function() {
                    var e = !1;
                    try {
                    ...
                    if (!e) {
                        ...
                        var u = i.URL;
                        u && (g.createObjectURL = function(e) {
                            ...
                            switch (u) {
                                ...
                                case "scheme":
                                    if (y && l.test(y)) v += y.toLowerCase();
                                        ...
                                        c(this._scheme) && (this._isRelative = !0), u = "file" === this._scheme ? "relative" : this._isRelative && n && n._scheme === this._scheme ? "relative or authority" : this._isRelative ? "authority first slash" : "scheme data"
                                    }
                                    break;
                                case "scheme data":
                                    "?" === y ? (this._query = "?", u = "query") : "#" === y ? (this._fragment = "#", u = "fragment") : y !== o && "\t" !== y && "\n" !== y && "\r" !== y && (this._schemeData += f(y));
                                    break;
                                case "no scheme":
                                    if (n && c(n._scheme)) {
                                        u = "relative";
                                ...
                                case "relative or authority":
                                    ...
                                    break;
                                case "relative":
                                    if (this._isRelative = !0, "file" !== this._scheme && (this._scheme = n._scheme), y === o) {
                                    ...
                                    if ("/" === y || "\\" === y) "\\" === y && i("\\ is an invalid code point."), u = "relative slash";
                                    else if ("?" === y) this._host = n._host, this._port = n._port, this._path = n._path.slice(), this._query = "?", this._username = n._username, this._password = n._password, u = "query";
                                    else {
                                        if ("#" !== y) {
                                            var A = e[m + 1],
                                                S = e[m + 2];
                                            ("file" !== this._scheme || !s.test(y) || ":" !== A && "|" !== A || S !== o && "/" !== S && "\\" !== S && "?" !== S && "#" !== S) && (this._host = n._host, this._port = n._port, this._username = n._username, this._password = n._password, this._path = n._path.slice(), this._path.pop()), u = "relative path";
                                            continue
                                        }
                                        this._host = n._host, this._port = n._port, this._path = n._path.slice(), this._query = n._query, this._fragment = "#", this._username = n._username, this._password = n._password, u = "fragment"
                                    }
                                    break;
                                case "relative slash":
                                    if ("/" !== y && "\\" !== y) {
                                        "file" !== this._scheme && (this._host = n._host, this._port = n._port, this._username = n._username, this._password = n._password), u = "relative path";
                                        continue
                                    }
                                    "\\" === y && i("\\ is an invalid code point."), u = "file" === this._scheme ? "file host" : "authority ignore slashes";
                                    break;
                                case "authority first slash":
                                    if ("/" !== y) {
                                        i("Expected '/', got: " + y), u = "authority ignore slashes";
                                        continue
                                    }
                                ...
                                case "file host":
                                    if (y === o || "/" === y || "\\" === y || "?" === y || "#" === y) {
                                        2 !== v.length || !s.test(v[0]) || ":" !== v[1] && "|" !== v[1] ? 0 === v.length ? u = "relative path start" : (this._host = d.call(this, v), v = "", u = "relative path start") : u = "relative path";
                                        continue
                                    }
                                    "\t" === y || "\n" === y || "\r" === y ? i("Invalid whitespace in file host.") : v += y;
                                    break;
                                case "host":
                                case "hostname":
                                    if (":" !== y || _) {
                                        if (y === o || "/" === y || "\\" === y || "?" === y || "#" === y) {
                                            if (this._host = d.call(this, v), v = "", u = "relative path start", t) break e;
                                            continue
                                        }
                                        "\t" !== y && "\n" !== y && "\r" !== y ? ("[" === y ? _ = !0 : "]" === y && (_ = !1), v += y) : i("Invalid code point in host/hostname: " + y)
                                    } else if (this._host = d.call(this, v), v = "", u = "port", "hostname" === t) break e;
                                    break;
                                case "port":
                                    if (/[0-9]/.test(y)) v += y;
                                    else {
                                        if (y === o || "/" === y || "\\" === y || "?" === y || "#" === y || t) {
                                            if ("" !== v) {
                                                var k = parseInt(v, 10);
                                                k !== r[this._scheme] && (this._port = k + ""), v = ""
                                            }
                                            if (t) break e;
                                            u = "relative path start";
                                            continue
                                        }
                                        "\t" === y || "\n" === y || "\r" === y ? i("Invalid code point in port: " + y) : h.call(this)
                                    }
                                    break;
                                case "relative path start":
                                    if ("\\" === y && i("'\\' not allowed in path."), u = "relative path", "/" !== y && "\\" !== y) continue;
                                    break;
                                case "relative path":
                                    var R;
                                    if (y !== o && "/" !== y && "\\" !== y && (t || "?" !== y && "#" !== y)) "\t" !== y && "\n" !== y && "\r" !== y && (v += f(y));
                                    else "\\" === y && i("\\ not allowed in relative path."), (R = a[v.toLowerCase()]) && (v = R), ".." === v ? (this._path.pop(), "/" !== y && "\\" !== y && this._path.push("")) : "." === v && "/" !== y && "\\" !== y ? this._path.push("") : "." !== v && ("file" === this._scheme && 0 === this._path.length && 2 === v.length && s.test(v[0]) && "|" === v[1] && (v = v[0] + ":"), this._path.push(v)), v = "", "?" === y ? (this._query = "?", u = "query") : "#" === y && (this._fragment = "#", u = "fragment");
                                    break;
                                case "query":
                                    t || "#" !== y ? y !== o && "\t" !== y && "\n" !== y && "\r" !== y && (this._query += p(y)) : (this._fragment = "#", u = "fragment");
                                    break;
                                case "fragment":
        ...
        var n = r(6),
            ...
            l = function() {
                var e, t = r(26)("iframe"),
                    n = a.length;
                for (t.style.display = "none", r(49).appendChild(t), t.src = "javascript:", (e = t.contentWindow.document).open(), e.write("<script>document.F=Object<\/script>"), e.close(), l = e.F; n--;) delete l.prototype[a[n]];
                return l()
            };
        e.exports = Object.create || function(e, t) {
            var r;
            return null !== e ? (s.prototype = n(e), r = new s, s.prototype = null, r[o] = e) : r = l(), void 0 === t ? r : i(r, t)
        }
    }, function(e, t, r) {
        "use strict";
        var n = r(14),
                    ...
                    _(function() {
                        for (var n = e._v, i = 1 == e._s, a = 0, o = function(t) {
                                var r, a, o, s = i ? t.ok : t.fail,
                                    ...
                                    c = t.domain;
                                try {
                                    s ? (i || (2 == e._h && F(e), e._h = 1), !0 === s ? r = n : (c && c.enter(), r = s(n), c && (c.exit(), o = !0)), r === t.promise ? u(S("Promise-chain cycle")) : (a = T(r)) ? a.call(r, l, u) : l(r)) : u(n)
                                } catch (e) {
                                    c && !o && c.exit(), u(e)
                                }
                            }; r.length > a;) o(r[a++]);
            ...
            O = function(e) {
                g.call(l, function() {
                    var t, r, n, i = e._v,
                        a = I(e);
                    if (a && (t = y(function() {
                            C ? w.emit("unhandledRejection", i, e) : (r = l.onunhandledrejection) ? r({
                                promise: e,
                                reason: i
                            }) : (n = l.console) && n.error && n.error("Unhandled promise rejection", i)
                        }), e._h = C || I(e) ? 2 : 1), e._a = void 0, a && t.e) throw t.v
                })
            },
            I = function(e) {
        ...
        x || (P = function(e) {
            ...
            then: function(e, t) {
                var r = R(v(this, P));
                return r.ok = "function" != typeof e || e, r.fail = "function" == typeof t && t, r.domain = C ? w.domain : void 0, this._c.push(r), this._a && this._a.push(r), this._s && E(this, !1), r.promise
            },
            catch: function(e) {
            ...
            var e = new n;
            this.promise = e, this.resolve = u(j, e, 1), this.reject = u(L, e, 1)
        }, b.f = R = function(e) {
            return e === P || e === o ? new a(e) : i(e)
        }), h(h.G + h.W + h.F * !x, {
            Promise: P
        }), r(22)(P, "Promise"), r(93)("Promise"), o = r(5).Promise, h(h.S + h.F * !x, "Promise", {
            reject: function(e) {
                var t = R(this);
        ...
        }) && (s((n = l.getConstructor(v, "WeakMap")).prototype, g), o.NEED = !0, i(["delete", "has", "get", "set"], function(e) {
            var t = _.prototype,
                r = t[e];
            a(t, e, function(t, i) {
                if (u(t) && !f(t)) {
        ...
        e.exports = !l || r(12)(function() {
            ...
            for (var r = o(e), l = arguments.length, u = 1, c = i.f, h = a.f; l > u;)
                for (var d, f = s(arguments[u++]), p = c ? n(f).concat(c(f)) : n(f), m = p.length, v = 0; m > v;) h.call(f, d = p[v++]) && (r[d] = f[d]);
            return r
        } : l
    }, function(e, t, r) {
        "use strict";
        ...
        v.prototype = {
            ...
            getConstructor: function(e, t, r, a) {
                var u = e(function(e, n) {
                    s(e, u, t, "_i"), e._t = t, e._i = p++, e._l = void 0, void 0 != n && l(n, r, e[a], e)
                });
                return n(u.prototype, {
                    delete: function(e) {
                        if (!o(e)) return !1;
                        var r = i(e);
                        return !0 === r ? m(h(this, t)).delete(e) : r && c(r, this._i) && delete r[this._i]
                    },
                    has: function(e) {
                        if (!o(e)) return !1;
                        var r = i(e);
        ...
        e.exports = function(e, t, r, m, v, g) {
            ...
            if ("function" == typeof b && (g || A.forEach && !h(function() {
                ...
                })).prototype = A, A.constructor = b), (k || x) && (w("delete"), w("has"), v && w("get")), (x || C) && w(y), g && A.clear && delete A.clear
            } else b = m.getConstructor(t, e, v, y), o(b.prototype, r), s.NEED = !0;
            return f(b, e), S[e] = b, i(i.G + i.W + i.F * (b != _), S), g || m.setStrong(b, e, v), b
        }
    }, function(e, t, r) {
        "use strict";
        var n = r(2),
        ...
        e.exports = {
            set: Object.setPrototypeOf || ("__proto__" in {} ? function(e, t, n) {
                try {
                    (n = r(9)(Function.call, r(107).f(Object.prototype, "__proto__").set, 2))(e, []), t = !(e instanceof Array)
                } catch (e) {
                    t = !0
                }
                return function(e, r) {
        ...
        e.exports = function(e) {
            n(n.S, e, {
                from: function(e) {
                    ...
                    return i(this), (t = void 0 !== l) && i(l), void 0 == e ? new this : (r = [], t ? (n = 0, s = a(l, arguments[2], 2), o(e, !1, function(e) {
                        r.push(s(e, n++))
        ...
        e.exports = function(e) {
            return function(t) {
                for (var r, o = i(t), s = n(o), l = s.length, u = 0, c = []; l > u;) a.call(o, r = s[u++]) && c.push(e ? [r, o[r]] : o[r]);
                return c
            }
        }
    }, function(e, t, r) {
        ...
        ! function(e, t) {
            ...
            t.typeIsObject = function(e) {
                ...
                a(t.typeIsObject(e)), Object.defineProperty(e, r, {
                    value: n,
                    writable: !0,
                    enumerable: !0,
                    configurable: !0
            ...
            n.prototype = Object.create(Error.prototype), n.prototype.constructor = n, e.exports = {
            ...
            function y(e) {
                return !!u(e) && !!Object.prototype.hasOwnProperty.call(e, "_writableStreamController")
            }

            function A(e) {
                return h(!0 === y(e), "IsWritableStreamLocked should only be used on known writable streams"), void 0 !== e._writer
            }
            ...
            function C(e) {
                h("erroring" === e._state, "stream._state === erroring"), h(!1 === x(e), "WritableStreamHasOperationMarkedInFlight(stream) === false"), e._state = "errored", e._writableStreamController.__errorSteps();
                ...
                if (e._writeRequests = [], void 0 !== e._pendingAbortRequest) {
                    ...
                    if (e._pendingAbortRequest = void 0, !0 === n._wasAlreadyErroring) return n._reject(t), void T(e);
            ...
            var O = function() {
                function e(t) {
                    if (i(this, e), !1 === y(t)) throw new TypeError("WritableStreamDefaultWriter can only be constructed with a WritableStream instance");
                    ...
                    var r, n = t._state;
                    if ("writable" === n) !1 === R(t) && !0 === t._backpressure ? ((r = this)._readyPromise = new Promise(function(e, t) {
                        r._readyPromise_resolve = e, r._readyPromise_reject = t
                    }), r._readyPromiseState = "pending") : K(this), Y(this);
                ...
                return n(e, [{
                    ...
                    value: function() {
                        ...
                        return void 0 === e ? Promise.reject(X("close")) : !0 === R(e) ? Promise.reject(new TypeError("cannot close an already-closing stream")) : F(this)
                    }
                }, {
                    key: "releaseLock",
                    value: function() {
            ...
            function I(e) {
                return !!u(e) && !!Object.prototype.hasOwnProperty.call(e, "_ownerWritableStream")
            }
            ...
            function F(e) {
                ...
                return !0 === t._backpressure && "writable" === r && J(e), n = t._writableStreamController, m(n, "close", 0), W(n), i
            }
            ...
            function D(e, t) {
                ...
                if (!0 === R(r) || "closed" === a) return Promise.reject(new TypeError("The stream is closing or closed and cannot be written to"));
            ...
            var N = function() {
                function e(t, r, n, a) {
                    if (i(this, e), !1 === y(t)) throw new TypeError("WritableStreamDefaultController can only be constructed with a WritableStream instance");
                    ...
                    var o = l(n, a);
                    this._strategySize = o.size, this._strategyHWM = o.highWaterMark, E(t, B(this))
                }
                return n(e, [{
                    key: "error",
                    value: function(e) {
                            ...
                            if (0 !== e._queue.length) {
                                ...
                                "close" === n ? function(e) {
                                    ...
                                    (function(e) {
                                        ...
                                        var t = r._state;
                                        if (h("writable" === t || "erroring" === t), p(e), !1 === R(r) && "writable" === t) {
                                            var n = B(e);
                                            E(r, n)
                                        }
                                        W(e)
            ...
            var a = r(0),
                ...
                L = function() {
                    ...
                    return n(e, [{
                        key: "cancel",
                        value: function(e) {
                            return !1 === M(this) ? Promise.reject(Te("cancel")) : !0 === D(this) ? Promise.reject(new TypeError("Cannot cancel a stream that already has a reader")) : U(this, e)
                        }
                    }, {
                        key: "getReader",
                        value: function() {
                        ...
                        value: function(e) {
                            ...
                            if (!1 === R(e)) return Promise.reject(new TypeError("ReadableStream.prototype.pipeTo's first argument must be a WritableStream"));
                            ...
                            if (!0 === x(e)) return Promise.reject(new TypeError("ReadableStream.prototype.pipeTo cannot be used on a locked WritableStream"));
                            var o = j(this),
                                s = k(e),
                                l = !1,
                                u = Promise.resolve();
                            return new Promise(function(r, c) {
                                ...
                                if (v(t, o._closedPromise, function(t) {
                                    ...
                                    }, "closed" === h._state ? f() : d.then(f).catch(y), !0 === F(e) || "closed" === e._state) {
                                ...
                                function g(t, r, n) {
                                    ...
                                    }!0 !== l && (l = !0, "writable" === e._state && !1 === F(e) ? m().then(i) : i())
                                }

                                function _(t, r) {
                                    !0 !== l && (l = !0, "writable" === e._state && !1 === F(e) ? m().then(function() {
                                        return b(t, r)
                                    }).catch(y) : b(t, r))
                                }
                                ...
                                function b(e, t) {
                                    ...
                                    return u = Promise.resolve(), !0 === l ? Promise.resolve() : s._readyPromise.then(function() {
                                        return re(o).then(function(e) {
                                            var t = e.value;
                                            !0 !== e.done && (u = I(s, t).catch(function() {}))
                                        })
                                    }).then(e)
                                })().catch(function(e) {
            ...
            function N(e, t) {
                ...
                var c = new L(u);
                return i._branch1 = l._readableStreamController, i._branch2 = c._readableStreamController, r._closedPromise.catch(function(e) {
                    !0 !== n.closedOrErrored && (le(i._branch1, e), le(i._branch2, e), n.closedOrErrored = !0)
                }), [l, c]
            }
            ...
            var Q = function() {
                    ...
                    return n(e, [{
                        key: "cancel",
                        value: function(e) {
                            return !1 === Z(this) ? Promise.reject(Oe("cancel")) : void 0 === this._ownerReadableStream ? Promise.reject(Ee("cancel")) : ee(this, e)
                        }
                    }, {
                        key: "read",
                        value: function() {
                            return !1 === Z(this) ? Promise.reject(Oe("read")) : void 0 === this._ownerReadableStream ? Promise.reject(Ee("read from")) : re(this)
                        }
                    }, {
                        key: "releaseLock",
                        value: function() {
                ...
                K = function() {
                    ...
                    return n(e, [{
                        key: "cancel",
                        value: function(e) {
                            return J(this) ? void 0 === this._ownerReadableStream ? Promise.reject(Ee("cancel")) : ee(this, e) : Promise.reject(Fe("cancel"))
                        }
                    }, {
                        key: "read",
                        value: function(e) {
                            return J(this) ? void 0 === this._ownerReadableStream ? Promise.reject(Ee("read from")) : ArrayBuffer.isView(e) ? 0 === e.byteLength ? Promise.reject(new TypeError("view must have non-zero byteLength")) : function(e, t) {
            ...
            var ne = function() {
                function e(t, r, n, a) {
                    ...
                    this._controlledReadableStream = t, this._underlyingSource = r, this._queue = void 0, this._queueTotalSize = void 0, P(this), this._started = !1, this._closeRequested = !1, this._pullAgain = !1, this._pulling = !1;
                    var o = d(n, a);
            ...
            var he = function() {
                ...
                de = function() {
                    function e(t, r, n) {
                        ...
                        this._controlledReadableStream = t, this._underlyingByteSource = r, this._pullAgain = !1, this._pulling = !1, ve(this), this._queue = this._queueTotalSize = void 0, P(this), this._closeRequested = !1, this._started = !1, this._strategyHWM = f(n);
                    ...
                    return n(e, [{
                            ...
                            ! function(e, t) {
                                ...
                                if (!0 === V(r))
                                    if (0 === X(r)) be(e, o, i, a);
                                        ...
                                        G(r, s, !1)
                                    } else !0 === Y(r) ? (be(e, o, i, a), Pe(e)) : (b(!1 === D(r), "stream must not be locked"), be(e, o, i, a))
                            }(this, e)
                        }
                    }, {
                        key: "error",
                        ...
                        value: function(e) {
                            ...
                            return P(this), c(this._underlyingByteSource, "cancel", [e])
                        }
                    }, {
                        key: "__pullSteps",
                        value: function() {
            ...
            function me(e) {
                !1 !== function(e) {
                    ...
                    "readable" === e._controlledReadableStream._state && Re(e, t)
                }).catch(y)) : e._pullAgain = !0)
            }
            ...
            function ye(e, t) {
                ...
                for (var c = e._queue; l > 0;) {
                    ...
                    o(t.buffer, f, h.buffer, h.byteOffset, d), h.byteLength === d ? c.shift() : (h.byteOffset += d, h.byteLength -= d), e._queueTotalSize -= d, Ae(e, d, t), l -= d
                }
                return !1 === u && (b(0 === e._queueTotalSize, "queue must be empty"), b(t.bytesFilled > 0), b(t.bytesFilled < t.elementSize)), u
            }
            ...
            function Se(e) {
                b("readable" === e._controlledReadableStream._state), 0 === e._queueTotalSize && !0 === e._closeRequested ? B(e._controlledReadableStream) : me(e)
            }
                ...
                if ("closed" === n._state) {
                    ...
                    function(e, t, r) {
                        ...
                        if (Ae(e, t, r), !(r.bytesFilled < r.elementSize)) {
                            ...
                            r.buffer = h(r.buffer), r.bytesFilled -= n, ge(e._controlledReadableStream, r), Pe(e)
                        }
                    }(e, t, r)
            }
            ...
            var T = function() {
                    ...
                    return n(e, [{
                        ...
                        value: function(e) {
                            return function(e, t) {
                                ...
                                return l(r, "transform", [t, n], k, [t, n]).then(function() {
                        ...
                        value: function() {
                            var e = this._transformStream;
                            return a(!1 === e._transforming), e._writableDone = !0, u(e._transformer, "flush", [e._transformStreamController]).then(function() {
                ...
                E = function() {
                    ...
                    return n(e, [{
                        ...
                        value: function() {
                            var e = this._transformStream;
                            return a(!0 === e._backpressure, "pull() should be never called while _backpressure is false"), a(void 0 !== e._backpressureChangePromise, "_backpressureChangePromise should have been initialized"), C(e, !1), e._backpressureChangePromise
                        }
                    }, {
                        key: "cancel",
                        value: function() {
                ...
                O = function() {
                    function e(t) {
                        if (i(this, e), !1 === x(t)) throw new TypeError("TransformStreamDefaultController can only be constructed with a TransformStream instance");
                ...
                I = function() {
                    function e() {
                        ...
                        var c = new T(this, l);
                        this._writable = new _(c, n), a(void 0 !== this._writableController), a(void 0 !== this._readableController), C(this, v(this._readableController) <= 0);
                        var h = this,
                            f = s(t, "start", [h._transformStreamController]);
                        o(f), l.catch(function(e) {
        ...
        var g = 65536,
            _ = !1,
            b = void 0,
            y = "undefined" != typeof document && document.currentScript ? document.currentScript.src : null,
            A = null,
            S = !1;
        "undefined" == typeof window ? (_ = !0, void 0 === require.ensure && (require.ensure = require("node-ensure")), S = !0) : "undefined" != typeof require && "function" == typeof require.ensure && (S = !0), "undefined" != typeof requirejs && requirejs.toUrl && (b = requirejs.toUrl("pdfjs-dist/build/pdf.worker.js"));
        var w, P = "undefined" != typeof requirejs && requirejs.load;
        A = S ? function(e) {
        ...
        var C = function() {
                ...
                return e.prototype = {
                    ...
                    onDataProgress: function(e) {
                        ...
                        this._readyCapability.promise.then(function() {
                            for (var r = t._progressListeners, n = 0, i = r.length; n < i; ++n) r[n](e)
                        })
                    },
                    onDataProgressiveRead: function(e) {
                        var t = this;
                        this._readyCapability.promise.then(function() {
                            for (var r = t._progressiveReadListeners, n = 0, i = r.length; n < i; ++n) r[n](e)
                        })
                    },
            ...
            x = function() {
                function e(e, t, r) {
                    ...
                    this.pageIndex = e, this.pageInfo = t, this.transport = r, this._stats = n ? new s.StatTimer : s.DummyStatTimer, this._pdfBug = n, this.commonObjs = r.commonObjs, this.objs = new I, this.cleanupAfterRender = !1, this.pendingCleanup = !1, this.intentStates = Object.create(null), this.destroyed = !1
                }
                return e.prototype = {get pageNumber() {
                    ...
                    render: function(e) {
                        ...
                        var n = "print" === e.intent ? "print" : "display",
                            ...
                            a = new v.WebGLContext({
                                enable: e.enableWebGL
                            });
                        this.intentStates[n] || (this.intentStates[n] = Object.create(null));
                        var l = this.intentStates[n];
                        l.displayReadyCapability || (l.receivingOperatorList = !0, l.displayReadyCapability = (0, o.createPromiseCapability)(), l.operatorList = {
                            fnArray: [],
                            argsArray: [],
                            lastChunk: !1
                        }, r.time("Page Request"), this.transport.messageHandler.send("RenderPageRequest", {
                        ...
                        var u = function(e) {
                                ...
                                n >= 0 && l.renderTasks.splice(n, 1), t.cleanupAfterRender && (t.pendingCleanup = !0), t._tryCleanup(), e ? c.capability.reject(e) : c.capability.resolve(), r.timeEnd("Rendering"), r.timeEnd("Overall")
                            },
                            c = new L(u, e, this.objs, this.commonObjs, l.operatorList, this.pageNumber, i, a, this._pdfBug);
                        c.useRequestAnimationFrame = "print" !== n, l.renderTasks || (l.renderTasks = []), l.renderTasks.push(c);
                        var h = c.task;
                        return l.displayReadyCapability.promise.then(function(e) {
                            t.pendingCleanup ? u() : (r.time("Rendering"), c.initializeGraphics(e), c.operatorListChanged())
                        }).catch(u), h
                    },
                        ...
                        return new Promise(function(e, r) {
                            ...
                            ! function t() {
                                n.read().then(function(r) {
                                    var n = r.value;
                                    r.done ? e(i) : (o.Util.extendObj(i.styles, n.styles), o.Util.appendToArray(i.items, n.items), t())
                                }, r)
                            }()
                        })
                    },
                    ...
                    _tryCleanup: function() {
                        ...
                        }, this), this.objs.clear(), this.annotationsPromise = null, e && this._stats instanceof s.StatTimer && (this._stats = new s.StatTimer), this.pendingCleanup = !1)
                    },
                    ...
                    value: function(e, t) {
                        ...
                        if (this._defer) {
                            var n = new WeakMap,
                                i = {
                                    data: function e(r) {
                                        if ("object" !== (void 0 === r ? "undefined" : a(r)) || null === r) return r;
                                        if (n.has(r)) return n.get(r);
                                        var i, s;
                                        if ((s = r.buffer) && (0, o.isArrayBuffer)(s)) {
                                            var l = t && t.includes(s);
                                            return i = r === s ? r : l ? new r.constructor(s, r.byteOffset, r.byteLength) : new r.constructor(r), n.set(r, i), i
                                        }
                                        for (var u in i = Array.isArray(r) ? [] : {}, n.set(r, i), r) {
                                            for (var c, h = r; !(c = Object.getOwnPropertyDescriptor(h, u));) h = Object.getPrototypeOf(h);
                                            void 0 !== c.value && "function" != typeof c.value && (i[u] = e(c.value))
                                        }
                                        return i
                                    }(e)
                                };
            ...
            E = function() {
                ...
                function t() {
                    if (f.GlobalWorkerOptions.workerSrc) return f.GlobalWorkerOptions.workerSrc;
                ...
                function a() {
                    ...
                    if (this.name = r, this.destroyed = !1, this.postMessageTransfers = !1 !== l, this.verbosity = (0, o.isNum)(c) ? c : (0, o.getVerbosityLevel)(), this._readyCapability = (0, o.createPromiseCapability)(), this._port = null, this._webWorker = null, this._messageHandler = null, a) return i.set(a, this), void this._initializeFromPort(a);
                    this._initialize()
                }
                return a.prototype = {get promise() {
                    ...
                    _initialize: function() {
                        ...
                        if ("undefined" != typeof Worker && !_ && !r()) {
                            var a = t();
                            try {
                                (0, o.isSameOrigin)(window.location.href, a) || (e = new URL(a, window.location).href, n = "importScripts('" + e + "');", a = URL.createObjectURL(new Blob([n])));
                                var s = new Worker(a),
                                    l = new o.MessageHandler("main", "worker", s),
                                    u = function() {
                                        s.removeEventListener("error", c), l.destroy(), s.terminate(), i.destroyed ? i._readyCapability.reject(new Error("Worker was destroyed")) : i._setupFakeWorker()
                                    },
                                    c = function() {
                                        i._webWorker || u()
                                    };
                                s.addEventListener("error", c), l.on("test", function(e) {
                                    (s.removeEventListener("error", c), i.destroyed) ? u(): e && e.supportTypedArray ? (i._messageHandler = l, i._port = s, i._webWorker = s, e.supportTransfers || (i.postMessageTransfers = !1), i._readyCapability.resolve(), l.send("configure", {
                                        verbosity: i.verbosity
                                    })) : (i._setupFakeWorker(), l.destroy(), s.terminate())
                                }), l.on("ready", function(e) {
                                    if (s.removeEventListener("error", c), i.destroyed) u();
                                    else try {
                                        h()
                                    } catch (e) {
                                        i._setupFakeWorker()
                                ...
                                var h = function() {
                                    ...
                                    try {
                                        ...
                                        (0, o.info)("Cannot use postMessage transfers"), e[0] = 0, l.send("test", e)
                                    }
                                };
                                return void h()
                            } catch (e) {
                    ...
                    _setupFakeWorker: function() {
                        ...
                        _ || ((0, o.warn)("Setting up fake worker."), _ = !0),
                            function() {
                                ...
                                var e = r();
                                return e ? (n.resolve(e), n.promise) : ((A || function(e) {
                                    o.Util.loadScript(t(), function() {
                                        e(window.pdfjsWorker.WorkerMessageHandler)
                                    })
                                })(n.resolve), n.promise)
                            }().then(function(t) {
                                if (i.destroyed) i._readyCapability.reject(new Error("Worker was destroyed"));
                                else {
            ...
            O = function() {
                function e(e, t, r, n, i) {
                    this.messageHandler = e, this.loadingTask = t, this.commonObjs = new I, this.fontLoader = new l.FontLoader(t.docId), this._params = n, this.CMapReaderFactory = new i({
                        baseUrl: n.cMapUrl,
                        isCompressed: n.cMapPacked
                    }), this.destroyed = !1, this.destroyCapability = null, this._passwordCapability = null, this._networkStream = r, this._fullReader = null, this._lastProgress = null, this.pageCache = [], this.pagePromises = [], this.downloadInfoCapability = (0, o.createPromiseCapability)(), this.setupMessageHandler()
                }
                return e.prototype = {
                    destroy: function() {
                        var e = this;
                        ...
                        e.on("GetReader", function(e, t) {
                            ...
                            (0, o.assert)(this._networkStream), this._fullReader = this._networkStream.getFullReader(), this._fullReader.onProgress = function(e) {
                                ...
                                r._fullReader.read().then(function(e) {
                                    var r = e.value;
                                    e.done ? t.close() : ((0, o.assert)((0, o.isArrayBuffer)(r)), t.enqueue(new Uint8Array(r), 1, [r]))
                                }).catch(function(e) {
                                    t.error(e)
                                })
                            ...
                            if (!this.destroyed) {
                                var r = e[0],
                                    n = e[1];
                                if (!this.commonObjs.hasData(r)) switch (n) {
                                    case "Font":
                                        var i = e[2],
                                            a = this._params;
                                        if ("error" in i) {
                                            var s = i.error;
                                            (0, o.warn)("Error during font loading: " + s), this.commonObjs.resolve(r, s);
                                            break
                                        }
                                        var u = null;
                                        a.pdfBug && d.default.FontInspector && d.default.FontInspector.enabled && (u = {
                            ...
                            if (!this.destroyed) {
                                var t, r = e[0],
                                    ...
                                    i = e[2],
                                    a = this.pageCache[n];
                                if (!a.objs.hasData(r)) switch (i) {
                                    case "JpegStream":
                                        return t = e[3], new Promise(function(e, r) {
                                            var n = new Image;
                                            n.onload = function() {
                                                e(n)
                                            }, n.onerror = function() {
            ...
            L = function() {
                ...
                return t.prototype = {
                    initializeGraphics: function(t) {
                        ...
                        if (!this.cancelled) {
                            this._pdfBug && d.default.StepperManager && d.default.StepperManager.enabled && (this.stepper = d.default.StepperManager.create(this.pageNumber - 1), this.stepper.init(this.operatorList), this.stepper.nextBreakPoint = this.stepper.getNextBreakPoint());
                            var r = this.params;
                            this.gfx = new c.CanvasGraphics(r.canvasContext, this.commonObjs, this.objs, this.canvasFactory, this.webGLContext, r.imageLayer), this.gfx.beginDrawing({
                    ...
                    cancel: function() {
                        this.running = !1, this.cancelled = !0, this._canvas && e.delete(this._canvas), this.callback(new s.RenderingCancelledException("Rendering cancelled, page " + this.pageNumber, "canvas"))
                    },
        ...
        t.version = "2.0.489", t.build = "7d7bc80e", t.getDocument = function(e) {
            var t, r = new C;
            if ("string" == typeof e) t = {
                url: e
            };
            else if ((0, o.isArrayBuffer)(e)) t = {
                data: e
            };
            else if (e instanceof k) t = {
                range: e
            };
            else {
            ...
            for (var h in t)
                if ("url" !== h || "undefined" == typeof window)
                    if ("range" !== h)
                        if ("worker" !== h)
                            if ("data" !== h || t[h] instanceof Uint8Array) "CMapReaderFactory" !== h ? n[h] = t[h] : c = t[h];
                            else {
                                var d = t[h];
                                if ("string" == typeof d) n[h] = (0, o.stringToBytes)(d);
                                else if ("object" !== (void 0 === d ? "undefined" : a(d)) || null === d || isNaN(d.length)) {
                                    if (!(0, o.isArrayBuffer)(d)) throw new Error("Invalid PDF binary data: either typed array, string or array-like object is expected in the data property.");
                                    n[h] = new Uint8Array(d)
                                } else n[h] = new Uint8Array(d)
                            } else l = t[h];
            else i = t[h];
            else n[h] = new URL(t[h], window.location).href;
            n.rangeChunkSize = n.rangeChunkSize || g, n.ignoreErrors = !0 !== n.stopAtErrors, n.pdfBug = !0 === n.pdfBug;
            var p = Object.values(o.NativeImageDecoding);
            if (void 0 !== n.nativeImageDecoderSupport && p.includes(n.nativeImageDecoderSupport) || (n.nativeImageDecoderSupport = o.NativeImageDecoding.DECODE), Number.isInteger(n.maxImageSize) || (n.maxImageSize = -1), "boolean" != typeof n.isEvalSupported && (n.isEvalSupported = !0), "boolean" != typeof n.disableFontFace && (n.disableFontFace = !1), "boolean" != typeof n.disableRange && (n.disableRange = u.apiCompatibilityParams.disableRange || !1), "boolean" != typeof n.disableStream && (n.disableStream = u.apiCompatibilityParams.disableStream || !1), "boolean" != typeof n.disableAutoFetch && (n.disableAutoFetch = !1), "boolean" != typeof n.disableCreateObjectURL && (n.disableCreateObjectURL = u.apiCompatibilityParams.disableCreateObjectURL || !1), (0, o.setVerbosityLevel)(n.verbosity), !l) {
                var v = {
                        postMessageTransfers: n.postMessageTransfers,
                        verbosity: n.verbosity
                    },
                    _ = f.GlobalWorkerOptions.workerPort;
                _ ? (v.port = _, l = E.fromPort(v)) : l = new E(v), r._worker = l
            }
            var b = r.docId;
            return l.promise.then(function() {
                if (r.destroyed) throw new Error("Loading aborted");
                return function(e, t, r, n) {
                    return e.destroyed ? Promise.reject(new Error("Worker was destroyed")) : (r && (t.length = r.length, t.initialData = r.initialData), e.messageHandler.sendWithPromise("GetDocRequest", {
                        docId: n,
                        apiVersion: "2.0.489",
                        source: {
                            data: t.data,
                    ...
                    if (r.destroyed) throw new Error("Loading aborted");
                    var t = void 0;
                    i ? t = new m.PDFDataTransportStream({
                        length: n.length,
        ...
        }, t.LoopbackPort = T, t.PDFDataRangeTransport = k, t.PDFWorker = E, t.PDFDocumentProxy = R, t.PDFPageProxy = x, t.setPDFNetworkStreamFactory = function(e) {
            w = e
        }, t.version = "2.0.489", t.build = "7d7bc80e"
    }, function(e, t, r) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
            value: !0
        ...
        Object.defineProperty(i.prototype, "loadTestFont", {
            ...
            for (var r = [], a = [], o = [], s = function(e) {
                ...
                }, l = i.isFontLoadingAPISupported && !i.isSyncFontLoadingSupported, u = 0, c = e.length; u < c; u++) {
                var h = e[u];
            ...
            l ? Promise.all(o).then(function() {
                p.complete()
            }) : r.length > 0 && !i.isSyncFontLoadingSupported ? this.prepareFontLoadEvent(r, a, p) : p.complete()
        }, i.prototype.queueLoadingCallback = function(e) {
            var t = this.loadingContext,
                r = {
                    id: "pdfjs-font-loading-" + t.nextRequestId++,
                    complete: function() {
                        for ((0, n.assert)(!r.end, "completeRequest() cannot be called twice"), r.end = Date.now(); t.requests.length > 0 && t.requests[0].end;) {
            ...
            document.body.appendChild(v),
                function e(t, r) {
                    ...
                    u.font = "30px " + t, u.fillText(".", 0, 20), u.getImageData(0, 0, 1, 1).data[3] > 0 ? r() : setTimeout(e.bind(null, t, r))
                }(h, function() {
        ...
        Object.defineProperty(i, "isSyncFontLoadingSupported", {
            get: function() {
                return (0, n.shadow)(i, "isSyncFontLoadingSupported", function() {
            ...
            o = function() {
                function e(e, t) {
                    var r = t.isEvalSupported,
                        ...
                        o = t.fontRegistry,
                        s = void 0 === o ? null : o;
                    for (var l in this.compiledGlyphs = Object.create(null), e) this[l] = e[l];
                    this.isEvalSupported = !1 !== n, this.disableFontFace = !0 === a, this.fontRegistry = s
                }
                return e.prototype = {
                    ...
                    createFontFaceRule: function() {
                        ...
                        return this.fontRegistry && this.fontRegistry.registerFont(this, r), i
                    },
                    getPathGenerator: function(e, t) {
                        if (!(t in this.compiledGlyphs)) {
                            var r, n, i, o = e.get(this.loadedName + "_path_" + t);
                            if (this.isEvalSupported && a.value) {
                                var s, l = "";
                                for (n = 0, i = o.length; n < i; n++) s = void 0 !== (r = o[n]).args ? r.args.join(",") : "", l += "c." + r.cmd + "(" + s + ");\n";
                                this.compiledGlyphs[t] = new Function("c", "size", l)
                            } else this.compiledGlyphs[t] = function(e, t) {
                                for (n = 0, i = o.length; n < i; n++) "scale" === (r = o[n]).cmd && (r.args = [t, -t]), e[r.cmd].apply(e, r.args)
                            }
                        }
            ...
            e.mozCurrentTransform || (e._originalSave = e.save, e._originalRestore = e.restore, e._originalRotate = e.rotate, e._originalScale = e.scale, e._originalTranslate = e.translate, e._originalTransform = e.transform, e._originalSetTransform = e.setTransform, e._transformMatrix = e._transformMatrix || [1, 0, 0, 1, 0, 0], e._transformStack = [], Object.defineProperty(e, "mozCurrentTransform", {
                ...
                get: function() {
                    var e = this._transformMatrix,
                        ...
                        s = t * i - r * n,
                        l = r * n - t * i;
                    return [i / s, r / l, n / l, t / s, (i * a - n * o) / l, (r * a - t * o) / s]
                }
            }), e.save = function() {
                var e = this._transformMatrix;
        ...
        var u = function() {
            ...
            c = function() {
                function e(e, t, r, n, i, a) {
                    this.ctx = e, this.current = new u, this.stateStack = [], this.pendingClip = null, this.pendingEOFill = !1, this.res = null, this.xobjs = null, this.commonObjs = t, this.objs = r, this.canvasFactory = n, this.webGLContext = i, this.imageLayer = a, this.groupStack = [], this.processingType3 = null, this.baseTransform = null, this.baseTransformStack = [], this.groupLevel = 0, this.smaskStack = [], this.smaskCounter = 0, this.tempSMask = null, this.cachedCanvases = new l(this.canvasFactory), e && s(e), this.cachedGetSinglePixelWidth = null
                }

                function t(e, t) {
                    if ("undefined" != typeof ImageData && t instanceof ImageData) e.putImageData(t, 0, 0);
                    else {
                        var r, i, s, l, u, c = t.height,
                            h = t.width,
                            d = c % a,
                            f = (c - d) / a,
                            p = 0 === d ? f : f + 1,
                        ...
                        if (t.kind === n.ImageKind.GRAYSCALE_1BPP) {
                            ...
                            for (i = 0; i < p; i++) {
                                for (l = i < f ? a : d, r = 0, s = 0; s < l; s++) {
                                    for (var C = b - v, k = 0, R = C > S ? h : 8 * C - 7, x = -8 & R, T = 0, E = 0; k < x; k += 8) E = g[v++], y[r++] = 128 & E ? w : P, y[r++] = 64 & E ? w : P, y[r++] = 32 & E ? w : P, y[r++] = 16 & E ? w : P, y[r++] = 8 & E ? w : P, y[r++] = 4 & E ? w : P, y[r++] = 2 & E ? w : P, y[r++] = 1 & E ? w : P;
                                    for (; k < R; k++) 0 === T && (E = g[v++], T = 128), y[r++] = E & T ? w : P, T >>= 1
                                }
                                for (; r < A;) y[r++] = 0;
                                e.putImageData(m, 0, i * a)
                            }
                        } else if (t.kind === n.ImageKind.RGBA_32BPP) {
                            for (s = 0, u = h * a * 4, i = 0; i < f; i++) _.set(g.subarray(v, v + u)), v += u, e.putImageData(m, 0, s), s += a;
                            i < p && (u = h * d * 4, _.set(g.subarray(v, v + u)), e.putImageData(m, 0, s))
                        } else {
                            if (t.kind !== n.ImageKind.RGB_24BPP) throw new Error("bad image kind: " + t.kind);
                            for (u = h * (l = a), i = 0; i < p; i++) {
                                for (i >= f && (u = h * (l = d)), r = 0, s = u; s--;) _[r++] = g[v++], _[r++] = g[v++], _[r++] = g[v++], _[r++] = 255;
                                e.putImageData(m, 0, i * a)
                            }
                        }
                    }
                ...
                function r(e, t) {
                    for (var r = t.height, n = t.width, i = r % a, o = (r - i) / a, s = 0 === i ? o : o + 1, l = e.createImageData(n, a), u = 0, c = t.data, h = l.data, d = 0; d < s; d++) {
                ...
                function m(e, t, r, n) {
                    ...
                    if (!t.transferMap && n.isEnabled) {
                        ...
                        var s, l = !!a,
                            ...
                            h = l ? a[2] : 0;
                        s = "Luminosity" === i ? p : f;
                        for (var m = Math.min(n, Math.ceil(1048576 / r)), v = 0; v < n; v += m) {
                            var g = Math.min(m, n - v),
                                _ = e.getImageData(0, v, r, g),
                                b = t.getImageData(0, v, r, g);
                            l && d(_.data, u, c, h), s(_.data, b.data, o), e.putImageData(b, 0, v)
                        }
                ...
                for (var y in e.prototype = {
                        ...
                        executeOperatorList: function(e, t, r, i) {
                            var a = e.argsArray,
                                ...
                                l = a.length;
                            if (l === s) return s;
                            for (var u, c = l - s > 10 && "function" == typeof r, h = c ? Date.now() + 15 : 0, d = 0, f = this.commonObjs, p = this.objs;;) {
                        ...
                        suspendSMaskGroup: function() {
                            var e = this.ctx;
                            this.groupLevel--, this.ctx = this.groupStack.pop(), m(this.ctx, this.current.activeSMask, e, this.webGLContext), this.ctx.restore(), this.ctx.save(), c(e, this.ctx), this.current.resumeSMaskCtx = e;
                        ...
                        endSMaskGroup: function() {
                            var e = this.ctx;
                            this.groupLevel--, this.ctx = this.groupStack.pop(), m(this.ctx, this.current.activeSMask, e, this.webGLContext), this.ctx.restore(), c(e, this.ctx);
                            var t = n.Util.transform(this.current.activeSMask.startTransformInverse, e.mozCurrentTransform);
                        ...
                        constructPath: function(e, t) {
                            for (var r = this.ctx, i = this.current, a = i.x, o = i.y, s = 0, l = 0, u = e.length; s < u; s++) switch (0 | e[s]) {
                                ...
                                case n.OPS.lineTo:
                                    ...
                                    break;
                                case n.OPS.curveTo:
                                    a = t[l + 4], o = t[l + 5], r.bezierCurveTo(t[l], t[l + 1], t[l + 2], t[l + 3], a, o), l += 6;
                                    break;
                                case n.OPS.curveTo2:
                                    r.bezierCurveTo(a, o, t[l], t[l + 1], t[l + 2], t[l + 3]), a = t[l + 2], o = t[l + 3], l += 4;
                                    break;
                                case n.OPS.curveTo3:
                                    a = t[l + 2], o = t[l + 3], r.bezierCurveTo(t[l], t[l + 1], a, o, a, o), l += 4;
                                    break;
                        ...
                        showText: function(e) {
                            ...
                            if (0 !== i) {
                                var a = this.ctx,
                                    ...
                                    p = r.defaultVMetrics,
                                    m = i * t.fontMatrix[0],
                                    v = t.textRenderingMode === n.TextRenderingMode.FILL && !r.disableFontFace && !t.patternFill;
                                a.save();
                                var g = void 0;
                                if (t.patternFill) {
                                    a.save();
                                ...
                                a.transform.apply(a, t.textMatrix), a.translate(t.x, t.y + t.textRise), u > 0 ? a.scale(c, -1) : a.scale(c, 1);
                                var b = t.lineWidth,
                                    y = t.textMatrixScale;
                                if (0 === y || 0 === b) {
                                    var A = t.textRenderingMode & n.TextRenderingMode.FILL_STROKE_MASK;
                                    A !== n.TextRenderingMode.STROKE && A !== n.TextRenderingMode.FILL_STROKE || (this.cachedGetSinglePixelWidth = null, b = .65 * this.getSinglePixelWidth())
                                } else b /= y;
                                ...
                                for (S = 0; S < h; ++S) {
                                    ...
                                    if ((0, n.isNum)(P)) w += f * P * i / 1e3;
                                        ...
                                        var C, k, R, x, T, E, O, I = !1,
                                            F = (P.isSpace ? l : 0) + s,
                                            L = P.fontChar,
                                            j = P.accent,
                                            M = P.width;
                                        if (d) T = P.vmetric || p, E = -(E = P.vmetric ? T[1] : .5 * M) * m, O = T[2] * m, M = T ? -T[0] : M, C = E / o, k = (w + O) / o;
                                        else C = w / o, k = 0;
                                        if (r.remeasure && M > 0) {
                                        ...
                                        }(P.isInFont || r.missingFile) && (v && !j ? a.fillText(L, C, k) : (this.paintChar(L, C, k, g), j && (R = C + j.offset.x / o, x = k - j.offset.y / o, this.paintChar(j.fontChar, R, x, g)))), w += M * m + F * u, I && a.restore()
                                    }
                                }
                        ...
                        showType3Text: function(e) {
                            var t, r, i, a, o = this.ctx,
                                ...
                                v = e.length;
                            if (!(s.textRenderingMode === n.TextRenderingMode.INVISIBLE) && 0 !== u) {
                                for (this.cachedGetSinglePixelWidth = null, o.save(), o.transform.apply(o, s.textMatrix), o.translate(s.x, s.y), o.scale(p, c), t = 0; t < v; ++t)
                                    if (r = e[t], (0, n.isNum)(r)) a = h * r * u / 1e3, this.ctx.translate(a, 0), s.x += a * p;
                                    else {
                                        var g = (r.isSpace ? f : 0) + d,
                                            _ = l.charProcOperatorList[r.operatorListId];
                                        if (_) this.processingType3 = r, this.save(), o.scale(u, u), o.transform.apply(o, m), this.executeOperatorList(_), this.restore(), i = n.Util.applyTransform([r.width, 0], m)[0] * u + g, o.translate(i, 0), s.x += i * p;
                        ...
                        beginGroup: function(e) {
                            ...
                            var o = Math.floor(i[0]),
                                ...
                                h = 1,
                                d = 1;
                            l > 4096 && (h = l / 4096, l = 4096), u > 4096 && (d = u / 4096, u = 4096);
                            var f = "groupAt" + this.groupLevel;
                            e.smask && (f += "_smask_" + this.smaskCounter++ % 2);
                            var p = this.cachedCanvases.getCanvas(f, l, u, !0),
                                m = p.context;
                            m.scale(1 / h, 1 / d), m.translate(-o, -s), m.transform.apply(m, r), e.smask ? this.smaskStack.push({
                                canvas: p.canvas,
                                context: m,
                                offsetX: o,
                                offsetY: s,
                            ...
                            }) : (t.setTransform(1, 0, 0, 1, 0, 0), t.translate(o, s), t.scale(h, d)), c(t, m), this.ctx = m, this.setGState([
                                ["BM", "source-over"],
                                ["ca", 1],
                                ["CA", 1]
                        ...
                        paintImageMaskXObject: function(e) {
                            ...
                            if (s && void 0 === s.compiled && (s.compiled = n <= 1e3 && i <= 1e3 ? function(e) {
                                    ...
                                    for (t = 0, i = h.length; t < i; t++)
                                        for (var p = 128, m = h[t]; p > 0;) d[f++] = m & p ? 0 : 255, p >>= 1;
                                    var v = 0;
                                    for (0 !== d[f = 0] && (l[0] = 1, ++v), r = 1; r < a; r++) d[f] !== d[f + 1] && (l[r] = d[f] ? 2 : 1, ++v), f++;
                                    for (0 !== d[f] && (l[r] = 2, ++v), t = 1; t < o; t++) {
                                        n = t * s, d[(f = t * c) - c] !== d[f] && (l[n] = d[f] ? 1 : 8, ++v);
                                        var g = (d[f] ? 4 : 0) + (d[f - c] ? 8 : 0);
                                        for (r = 1; r < a; r++) u[g = (g >> 2) + (d[f + 1] ? 4 : 0) + (d[f - c + 1] ? 8 : 0)] && (l[n + r] = u[g], ++v), f++;
                                        if (d[f - c] !== d[f] && (l[n + r] = d[f] ? 2 : 4, ++v), v > 1e3) return null
                                    }
                                    for (n = t * s, 0 !== d[f = c * (o - 1)] && (l[n] = 8, ++v), r = 1; r < a; r++) d[f] !== d[f + 1] && (l[n + r] = d[f] ? 4 : 8, ++v), f++;
                                    if (0 !== d[f] && (l[n + r] = 4, ++v), v > 1e3) return null;
                                    ...
                                    for (t = 0; v && t <= o; t++) {
                                        ...
                                        if (y !== A) {
                                            ...
                                            do {
                                                ...
                                                5 !== (S = l[y]) && 10 !== S ? (P = S, l[y] = 0) : (P = S & 51 * P >> 4, l[y] &= P >> 2 | P << 2), w.push(y % s), w.push(y / s | 0), --v
                                            } while (C !== y);
                                            b.push(w), --t
                                        }
                                    }
                                ...
                                var l = this.cachedCanvases.getCanvas("maskCanvas", n, i),
                                    u = l.context;
                                u.save(), r(u, e), u.globalCompositeOperation = "source-in", u.fillStyle = o ? a.getPattern(u, this) : a, u.fillRect(0, 0, n, i), u.restore(), this.paintInlineImageXObject(l.canvas)
                            }
                        },
                        paintImageMaskXObjectRepeat: function(e, t, n, i) {
                            ...
                            for (var h = this.ctx, d = 0, f = i.length; d < f; d += 2) h.save(), h.transform(t, 0, 0, n, i[d], i[d + 1]), h.scale(1, -1), h.drawImage(u.canvas, 0, 0, a, o, 0, -1, 1, 1), h.restore()
                        },
                        paintImageMaskXObjectGroup: function(e) {
                            for (var t = this.ctx, n = this.current.fillColor, i = this.current.patternFill, a = 0, o = e.length; a < o; a++) {
                                var s = e[a],
                                    ...
                                    h = c.context;
                                h.save(), r(h, s), h.globalCompositeOperation = "source-in", h.fillStyle = i ? n.getPattern(h, this) : n, h.fillRect(0, 0, l, u), h.restore(), t.save(), t.transform.apply(t, s.transform), t.scale(1, -1), t.drawImage(c.canvas, 0, 0, l, u, 0, -1, 1, 1), t.restore()
                            }
                        },
                        ...
                        paintImageXObjectRepeat: function(e, t, r, i) {
                            ...
                            if (a) {
                                for (var o = a.width, s = a.height, l = [], u = 0, c = i.length; u < c; u += 2) l.push({
                        ...
                        paintInlineImageXObject: function(e) {
                            ...
                            for (var m = r, v = n, g = "prescale1"; c > 2 && m > 1 || f > 2 && v > 1;) {
                                var _ = m,
                                    b = v;
                                c > 2 && m > 1 && (c /= m / (_ = Math.ceil(m / 2))), f > 2 && v > 1 && (f /= v / (b = Math.ceil(v / 2))), (p = (o = this.cachedCanvases.getCanvas(g, _, b)).context).clearRect(0, 0, _, b), p.drawImage(a, 0, 0, m, v, 0, 0, _, b), a = o.canvas, m = _, v = b, g = "prescale1" === g ? "prescale2" : "prescale1"
                            }
                        ...
                        paintInlineImageXObjectGroup: function(e, r) {
                            ...
                            for (var s = 0, l = r.length; s < l; s++) {
                                var u = r[s];
                                if (n.save(), n.transform.apply(n, u.transform), n.scale(1, -1), n.drawImage(o.canvas, u.x, u.y, u.w, u.h, 0, -1, 1, 1), this.imageLayer) {
                    ...
                    }, n.OPS) e.prototype[n.OPS[y]] = e.prototype[y];
                return e
            }();
        t.CanvasGraphics = c
    }, function(e, t, r) {
        ...
        var n = r(0),
            ...
            a = function() {
                function e(e, t, r, n, i, a, o, s) {
                    ...
                    if (!(p >= _))
                        for (var b, y, A, S, w, P, C, k, R, x = c[a], T = c[a + 1], E = c[a + 2], O = c[o], I = c[o + 1], F = c[o + 2], L = c[s], j = c[s + 1], M = c[s + 2], D = Math.round(p), N = Math.round(_), q = D; q <= N; q++) {
                            q < v ? (b = f - (f - m) * (R = q < p ? 0 : p === v ? 1 : (p - q) / (p - v)), y = x - (x - O) * R, A = T - (T - I) * R, S = E - (E - F) * R) : (b = m - (m - g) * (R = q > _ ? 1 : v === _ ? 0 : (v - q) / (v - _)), y = O - (O - L) * R, A = I - (I - j) * R, S = F - (F - M) * R), w = f - (f - g) * (R = q < p ? 0 : q > _ ? 1 : (p - q) / (p - _)), P = x - (x - L) * R, C = T - (T - j) * R, k = E - (E - M) * R;
                            for (var W = Math.round(Math.min(b, w)), U = Math.round(Math.max(b, w)), B = d * q + 4 * W, z = W; z <= U; z++) R = (R = (b - z) / (b - w)) < 0 ? 0 : R > 1 ? 1 : R, h[B++] = y - (y - P) * R | 0, h[B++] = A - (A - C) * R | 0, h[B++] = S - (S - k) * R | 0, h[B++] = 255
                        }
                }
                    ...
                    switch (r.type) {
                        case "lattice":
                            var l = r.verticesPerRow,
                                ...
                                c = l - 1;
                            for (i = 0; i < u; i++)
                                for (var h = i * l, d = 0; d < c; d++, h++) e(t, n, o[h], o[h + 1], o[h + l], s[h], s[h + 1], s[h + l]), e(t, n, o[h + l + 1], o[h + 1], o[h + l], s[h + l + 1], s[h + 1], s[h + l]);
                            break;
                        case "triangles":
                ...
                return function(e, r, n, i, a, o, s, l) {
                    var u, c, h, d, f = Math.floor(e[0]),
                        ...
                        S = g + 4,
                        w = _ + 4;
                    if (l.isEnabled) u = l.drawFigures({
                        width: g,
                        height: _,
                        backgroundColor: o,
                        figures: a,
                        context: A
                    }), (c = s.getCanvas("mesh", S, w, !1)).context.drawImage(u, 2, 2), u = c.canvas;
                    else {
                        var P = (c = s.getCanvas("mesh", S, w, !1)).context,
                            C = P.createImageData(g, _);
                        if (o) {
                            var k = C.data;
                            for (h = 0, d = k.length; h < d; h += 4) k[h] = o[0], k[h + 1] = o[1], k[h + 2] = o[2], k[h + 3] = 255
                        }
            ...
            fromIR: function(e) {
                ...
                return {
                    ...
                    getPattern: function(e, u, c) {
                        ...
                        else if (h = n.Util.singularValueDecompose2dScale(u.baseTransform), s) {
                            var d = n.Util.singularValueDecompose2dScale(s);
                            h = [h[0] * d[0], h[1] * d[1]]
                        }
                        var f = a(o, h, t, r, i, c ? null : l, u.cachedCanvases, u.webGLContext);
            ...
            return r.prototype = {
                createPatternCanvas: function(e) {
                    ...
                    var c = r[0],
                        ...
                        y = [_[0] * b[0], _[1] * b[1]];
                    v = Math.min(Math.ceil(Math.abs(v * y[0])), 3e3), g = Math.min(Math.ceil(Math.abs(g * y[1])), 3e3);
                    var A = e.cachedCanvases.getCanvas("pattern", v, g, !0),
                        S = A.context,
                        w = u.createCanvasGraphics(S);
                    w.groupLevel = e.groupLevel, this.setFillAndStrokeStyleToContext(w, o, l), this.setScale(v, g, i, a), this.transformToScale(w);
                    var P = [1, 0, 0, 1, -p[0], -p[1]];
                    return w.transform.apply(w, P), this.clipBbox(w, r, c, h, d, f), w.executeOperatorList(t), A.canvas
                },
        ...
        var l = function() {
                ...
                return i(e, [{
                    ...
                    value: function(e, t) {
                        ...
                        for (r = e.substring(t, n), a(); n < e.length && ">" !== e[n] && "/" !== e[n] && "?" !== e[n];) {
                            a();
                            for (var o, l = ""; n < e.length && !s(e, n) && "=" !== e[n];) l += e[n], ++n;
                            ...
                            if ("<" === e[t]) {
                                ...
                                switch (e[++r]) {
                                    ...
                                    default:
                                        ...
                                        if (null === u) return void this.onError(o.MalformedElement);
                                        var c = !1;
                                        if ("/>" === e.substring(r + u.parsed, r + u.parsed + 2)) c = !0;
                                        else if (">" !== e.substring(r + u.parsed, r + u.parsed + 1)) return void this.onError(o.UnterminatedElement);
                                        this.onBeginElement(u.name, u.attributes, c), r += u.parsed + (c ? 2 : 1)
                                }
                            } else {
            ...
            u = function() {
                function e(t, r) {
                    a(this, e), this.nodeName = t, this.nodeValue = r, Object.defineProperty(this, "parentNode", {
                        value: null,
                        writable: !0
                    })
                }
            ...
            c = function(e) {
                ...
                return function(e, t) {
                    ...
                    key: "parseFromString",
                    value: function(e) {
                        if (this._currentFragment = [], this._stack = [], this._errorCode = o.NoError, this.parseXml(e), this._errorCode === o.NoError) return {
                            documentElement: n(this._currentFragment, 1)[0]
                        }
                    }
                }, {
                    key: "onResolveEntity",
        ...
        var a = function() {
            ...
            o = function() {
                ...
                function s() {
                    a || (o = document.createElement("canvas"), a = o.getContext("webgl", {
                ...
                var l = "  attribute vec2 a_position;                                      attribute vec2 a_texCoord;                                                                                                      uniform vec2 u_resolution;                                                                                                      varying vec2 v_texCoord;                                                                                                        void main() {                                                     vec2 clipSpace = (a_position / u_resolution) * 2.0 - 1.0;       gl_Position = vec4(clipSpace * vec2(1, -1), 0, 1);                                                                              v_texCoord = a_texCoord;                                      }                                                             ",
                    u = "  precision mediump float;                                                                                                        uniform vec4 u_backdrop;                                        uniform int u_subtype;                                          uniform sampler2D u_image;                                      uniform sampler2D u_mask;                                                                                                       varying vec2 v_texCoord;                                                                                                        void main() {                                                     vec4 imageColor = texture2D(u_image, v_texCoord);               vec4 maskColor = texture2D(u_mask, v_texCoord);                 if (u_backdrop.a > 0.0) {                                         maskColor.rgb = maskColor.rgb * maskColor.a +                                   u_backdrop.rgb * (1.0 - maskColor.a);         }                                                               float lum;                                                      if (u_subtype == 0) {                                             lum = maskColor.a;                                            } else {                                                          lum = maskColor.r * 0.3 + maskColor.g * 0.59 +                        maskColor.b * 0.11;                                     }                                                               imageColor.a *= lum;                                            imageColor.rgb *= imageColor.a;                                 gl_FragColor = imageColor;                                    }                                                             ",
                    c = null;
                ...
                return {
                    ...
                    composeSMask: function(e, h, d) {
                        ...
                        c || function() {
                            ...
                            var f = i.getAttribLocation(h, "a_texCoord"),
                                ...
                                v = i.createBuffer();
                            i.bindBuffer(i.ARRAY_BUFFER, v), i.bufferData(i.ARRAY_BUFFER, new Float32Array([0, 0, 1, 0, 0, 1, 0, 1, 1, 0, 1, 1]), i.STATIC_DRAW), i.enableVertexAttribArray(f), i.vertexAttribPointer(f, 2, i.FLOAT, !1, 0, 0), i.uniform1i(p, 0), i.uniform1i(m, 1), c = d
                        }();
                        var m = c,
                            v = m.canvas,
                            g = m.gl;
                        v.width = f, v.height = p, g.viewport(0, 0, g.drawingBufferWidth, g.drawingBufferHeight), g.uniform2f(m.resolutionLocation, f, p), d.backdrop ? g.uniform4f(m.resolutionLocation, d.backdrop[0], d.backdrop[1], d.backdrop[2], 1) : g.uniform4f(m.resolutionLocation, 0, 0, 0, 0), g.uniform1i(m.subtypeLocation, "Luminosity" === d.subtype ? 1 : 0);
                        var _ = i(g, e, g.TEXTURE0),
                            b = i(g, h, g.TEXTURE1),
                            y = g.createBuffer();
                        return g.bindBuffer(g.ARRAY_BUFFER, y), g.bufferData(g.ARRAY_BUFFER, new Float32Array([0, 0, f, 0, 0, p, 0, p, f, 0, f, p]), g.STATIC_DRAW), g.enableVertexAttribArray(m.positionLocation), g.vertexAttribPointer(m.positionLocation, 2, g.FLOAT, !1, 0, 0), g.clearColor(0, 0, 0, 0), g.enable(g.BLEND), g.blendFunc(g.ONE, g.ONE_MINUS_SRC_ALPHA), g.clear(g.COLOR_BUFFER_BIT), g.drawArrays(g.TRIANGLES, 0, 6), g.flush(), g.deleteTexture(_), g.deleteTexture(b), g.deleteBuffer(y), v
                    },
                    drawFigures: function(e, i, l, u, c) {
                        f || function() {
                            ...
                            i.useProgram(l);
                            var u = {};
                            u.gl = i, u.canvas = e, u.resolutionLocation = i.getUniformLocation(l, "u_resolution"), u.scaleLocation = i.getUniformLocation(l, "u_scale"), u.offsetLocation = i.getUniformLocation(l, "u_offset"), u.positionLocation = i.getAttribLocation(l, "a_position"), u.colorLocation = i.getAttribLocation(l, "a_color"), f = u
                        }();
                        var p = f,
                            m = p.canvas,
                            v = p.gl;
                        m.width = e, m.height = i, v.viewport(0, 0, v.drawingBufferWidth, v.drawingBufferHeight), v.uniform2f(p.resolutionLocation, e, i);
                        var g, _, b, y = 0;
                        for (g = 0, _ = u.length; g < _; g++) switch (u[g].type) {
                            case "lattice":
                                y += ((b = u[g].coords.length / u[g].verticesPerRow | 0) - 1) * (u[g].verticesPerRow - 1) * 6;
                                break;
                            case "triangles":
                                y += u[g].coords.length
                        }
                        ...
                        for (g = 0, _ = u.length; g < _; g++) {
                            ...
                            switch (R.type) {
                                case "lattice":
                                    ...
                                    b = x.length / E | 0;
                                    for (var O = 1; O < b; O++)
                                        for (var I = O * E + 1, F = 1; F < E; F++, I++) A[C] = w[x[I - E - 1]], A[C + 1] = w[x[I - E - 1] + 1], A[C + 2] = w[x[I - E]], A[C + 3] = w[x[I - E] + 1], A[C + 4] = w[x[I - 1]], A[C + 5] = w[x[I - 1] + 1], S[k] = P[T[I - E - 1]], S[k + 1] = P[T[I - E - 1] + 1], S[k + 2] = P[T[I - E - 1] + 2], S[k + 3] = P[T[I - E]], S[k + 4] = P[T[I - E] + 1], S[k + 5] = P[T[I - E] + 2], S[k + 6] = P[T[I - 1]], S[k + 7] = P[T[I - 1] + 1], S[k + 8] = P[T[I - 1] + 2], A[C + 6] = A[C + 2], A[C + 7] = A[C + 3], A[C + 8] = A[C + 4], A[C + 9] = A[C + 5], A[C + 10] = w[x[I]], A[C + 11] = w[x[I] + 1], S[k + 9] = S[k + 3], S[k + 10] = S[k + 4], S[k + 11] = S[k + 5], S[k + 12] = S[k + 6], S[k + 13] = S[k + 7], S[k + 14] = S[k + 8], S[k + 15] = P[T[I]], S[k + 16] = P[T[I] + 1], S[k + 17] = P[T[I] + 2], C += 12, k += 18;
                                    break;
                                case "triangles":
                                    for (var L = 0, j = x.length; L < j; L++) A[C] = w[x[L]], A[C + 1] = w[x[L] + 1], S[k] = P[T[L]], S[k + 1] = P[T[L] + 1], S[k + 2] = P[T[L] + 2], C += 2, k += 3
                            }
                        }
                        l ? v.clearColor(l[0] / 255, l[1] / 255, l[2] / 255, 1) : v.clearColor(0, 0, 0, 0), v.clear(v.COLOR_BUFFER_BIT);
                        var M = v.createBuffer();
                        v.bindBuffer(v.ARRAY_BUFFER, M), v.bufferData(v.ARRAY_BUFFER, A, v.STATIC_DRAW), v.enableVertexAttribArray(p.positionLocation), v.vertexAttribPointer(p.positionLocation, 2, v.FLOAT, !1, 0, 0);
                        var D = v.createBuffer();
                        return v.bindBuffer(v.ARRAY_BUFFER, D), v.bufferData(v.ARRAY_BUFFER, S, v.STATIC_DRAW), v.enableVertexAttribArray(p.colorLocation), v.vertexAttribPointer(p.colorLocation, 3, v.UNSIGNED_BYTE, !1, 0, 0), v.uniform2f(p.scaleLocation, c.scaleX, c.scaleY), v.uniform2f(p.offsetLocation, c.offsetX, c.offsetY), v.drawArrays(v.TRIANGLES, 0, y), v.flush(), v.deleteBuffer(M), v.deleteBuffer(D), m
                    },
                    cleanup: function() {
        ...
        var s = function() {
            ...
            function n(e, n, a) {
                ...
                if (e._textDivs.push(s), o = n.str, !t.test(o)) return l.isWhitespace = !0, void e._textDivProperties.set(s, l);
                var u = i.Util.transform(e._viewport.transform, n.transform),
                    c = Math.atan2(u[1], u[0]),
                    h = a[n.fontName];
                h.vertical && (c += Math.PI / 2);
                var d, f, p = Math.sqrt(u[2] * u[2] + u[3] * u[3]),
                    m = p;
                if (h.ascent ? m = h.ascent * m : h.descent && (m = (1 + h.descent) * m), 0 === c ? (d = u[4], f = u[5] - m) : (d = u[4] + m * Math.sin(c), f = u[5] - m * Math.cos(c)), r[1] = d, r[3] = f, r[5] = p, r[7] = h.fontFamily, l.style = r.join(""), s.setAttribute("style", l.style), s.textContent = n.str, e._fontInspectorEnabled && (s.dataset.fontName = n.fontName), 0 !== c && (l.angle = c * (180 / Math.PI)), n.str.length > 1 && (h.vertical ? l.canvasWidth = n.height * e._viewport.scale : l.canvasWidth = n.width * e._viewport.scale), e._textDivProperties.set(s, l), e._textContentStream && e._layoutText(s), e._enhanceTextSelection) {
                    var v = 1,
                        g = 0;
                    0 !== c && (v = Math.cos(c), g = Math.sin(c));
                    var _, b, y = (h.vertical ? n.height : n.width) * e._viewport.scale,
                        A = p;
                    0 !== c ? (_ = [v, g, -g, v, d, f], b = i.Util.getAxialAlignedBoundingBox([0, 0, y, A], _)) : b = [d, f, d + y, f + A], e._bounds.push({
                        left: b[0],
                        top: b[1],
                        right: b[2],
                        bottom: b[3],
            ...
            function l(e, t) {
                ...
                t.forEach(function(e) {
                    ...
                    for (o = t; o <= a; o++) {
                        var u;
                        (u = (i = (n = r[o]).boundary).x2 > e.x1 ? i.index > e.index ? i.x1New : e.x1 : void 0 === i.x2New ? (i.x2 + e.x1) / 2 : i.x2New) > l && (l = u)
                    }
                    for (e.x1New = l, o = t; o <= a; o++) void 0 === (i = (n = r[o]).boundary).x2New ? i.x2 > e.x1 ? i.index > e.index && (i.x2New = i.x2) : i.x2New = l : i.x2New > l && (i.x2New = Math.max(l, i.x2));
                    var c = [],
                        h = null;
                    for (o = t; o <= a; o++) {
                        var d = (i = (n = r[o]).boundary).x2 > e.x2 ? i : e;
                        h === d ? c[c.length - 1].end = n.end : (c.push({
                            start: n.start,
                            end: n.end,
                            boundary: d
                        }), h = d)
                    ...
                    for (r[t].start < e.y1 && (c[0].start = e.y1, c.unshift({
                        ...
                        })), e.y2 < r[a].end && (c[c.length - 1].end = e.y2, c.push({
                            start: e.y2,
                            end: r[a].end,
            ...
            return u.prototype = {get promise() {
                        return this._capability.promise
                    },
                    cancel: function() {
                            ...
                            this._reader = this._textContentStream.getReader(),
                                function e() {
                                    t._reader.read().then(function(a) {
                                        var o = a.value;
                                        a.done ? r.resolve() : (i.Util.extendObj(n, o.styles), t._processItems(o.items, n), e())
                                    }, r.reject)
                                }()
                        }
        ...
        var u = function() {
                            ...
                            case a.AnnotationType.WIDGET:
                                switch (e.data.fieldType) {
                                    case "Tx":
                                        return new p(e);
                                    case "Btn":
                                        return e.data.radioButton ? new v(e) : e.data.checkBox ? new m(e) : new g(e);
                                    case "Ch":
                                        return new _(e)
                                }
                                return new f(e);
            ...
            c = function() {
                ...
                return n(e, [{
                    ...
                    value: function() {
                        ...
                        var l = a.Util.normalizeRect([t.rect[0], r.view[3] - t.rect[1] + r.view[1], t.rect[2], r.view[3] - t.rect[3] + r.view[1]]);
                        ...
                        return i.style.left = l[0] + "px", i.style.top = l[1] + "px", i.style.width = o + "px", i.style.height = s + "px", i
                    }
                }, {
                    key: "_createPopup",
                    value: function(e, t, r) {
            ...
            h = function(e) {
                ...
                return s(t, c), n(t, [{
                    ...
                    value: function() {
                        ...
                        return (0, i.addLinkAttributes)(r, {
                            url: e.url,
                            target: e.newWindow ? i.LinkTarget.BLANK : t.externalLinkTarget,
                            rel: t.externalLinkRel
                        }), e.url || (e.action ? this._bindNamedAction(r, e.action) : this._bindLink(r, e.dest)), this.container.appendChild(r), this.container
                    }
                }, {
                    key: "_bindLink",
                    value: function(e, t) {
            ...
            m = function(e) {
                function t(e) {
                    return l(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, e.renderInteractiveForms))
                }
                return s(t, f), n(t, [{
                    key: "render",
                    value: function() {
            ...
            b = function(e) {
                ...
                return s(t, c), n(t, [{
                    key: "render",
                    value: function() {
                        if (this.container.className = "popupAnnotation", ["Line", "Square", "Circle", "PolyLine", "Polygon"].includes(this.data.parentType)) return this.container;
            ...
            y = function() {
                function e(t) {
                    l(this, e), this.container = t.container, this.trigger = t.trigger, this.color = t.color, this.title = t.title, this.contents = t.contents, this.hideWrapper = t.hideWrapper || !1, this.pinned = !1
                }
                return n(e, [{
                    key: "render",
                    value: function() {
            ...
            P = function(e) {
                function t(e) {
                    l(this, t);
                    var r = !!(e.data.hasPopup || e.data.title || e.data.contents),
                        n = o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, r, !0));
            ...
            O = function(e) {
                function t(e) {
                    l(this, t);
                    var r = o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, !0)),
                        n = r.data.file;
                    return r.filename = (0, i.getFilenameFromUrl)(n.filename), r.content = n.content, r.linkService.onFileAttachmentAnnotation({
        ...
        var l, u = {
            ...
            c = function() {
                ...
                function c(r, n, a, o) {
                    ...
                    var v, g, _ = new Uint8Array((1 + d) * p),
                        b = 0,
                        y = 0;
                    for (v = 0; v < p; ++v) _[b++] = 0, _.set(m.subarray(y, y + d), b), y += d, b += d;
                    ...
                    var A = new Uint8Array([f >> 24 & 255, f >> 16 & 255, f >> 8 & 255, 255 & f, p >> 24 & 255, p >> 16 & 255, p >> 8 & 255, 255 & p, c, h, 0, 0, 0]),
                        ...
                        P = new Uint8Array(w),
                        C = 0;
                    return P.set(e, C), l("IHDR", A, P, C += e.length), l("IDATA", S, P, C += t + A.length), C += t + S.length, l("IEND", new Uint8Array(0), P, C), (0, i.createObjectURL)(P, "image/png", a)
                }
                return function(e, t, r) {
            ...
            h = function() {
                function e() {
                    this.fontSizeScale = 1, this.fontWeight = u.fontWeight, this.fontSize = 0, this.textMatrix = i.IDENTITY_MATRIX, this.fontMatrix = i.FONT_IDENTITY_MATRIX, this.leading = 0, this.x = 0, this.y = 0, this.lineX = 0, this.lineY = 0, this.charSpacing = 0, this.wordSpacing = 0, this.textHScale = 1, this.textRise = 0, this.fillColor = u.fillColor, this.strokeColor = "#000000", this.fillAlpha = 1, this.strokeAlpha = 1, this.lineWidth = 1, this.lineJoin = "", this.lineCap = "", this.miterLimit = 0, this.dashArray = [], this.dashPhase = 0, this.dependencies = [], this.activeClipUrl = null, this.clipGroup = null, this.maskId = ""
                }
                return e.prototype = {
                    clone: function() {
                        return Object.create(this)
        ...
        t.SVGGraphics = l = function() {
            ...
            return r.prototype = {
                ...
                convertOpList: function(e) {
                    ...
                    return function(e) {
                        for (var t = [], r = [], n = e.length, i = 0; i < n; i++) "save" !== e[i].fn ? "restore" === e[i].fn ? t = r.pop() : t.push(e[i]) : (t.push({
                            fnId: 92,
                            fn: "group",
                            items: []
                ...
                showText: function(r) {
                    ...
                    if (0 !== o) {
                        ...
                        for (s = 0; s < f; ++s) {
                            var g = r[s];
                            if (null !== g)
                                if ((0, i.isNum)(g)) v += -g * o * .001;
                                else {
                                    var _ = g.width,
                                        b = g.fontChar,
                                        y = _ * m + ((g.isSpace ? c : 0) + l) * h;
                                    g.isInFont || a.missingFile ? (n.xcoords.push(n.x + v * d), n.tspan.textContent += b, v += y) : v += y
                                } else v += h * c
                        }
                        p ? n.y -= v * d : n.x += v * d, n.tspan.setAttributeNS(null, "x", n.xcoords.map(e).join(" ")), n.tspan.setAttributeNS(null, "y", e(-n.y)), n.tspan.setAttributeNS(null, "font-family", n.fontFamily), n.tspan.setAttributeNS(null, "font-size", e(n.fontSize) + "px"), n.fontStyle !== u.fontStyle && n.tspan.setAttributeNS(null, "font-style", n.fontStyle), n.fontWeight !== u.fontWeight && n.tspan.setAttributeNS(null, "font-weight", n.fontWeight), n.fillColor !== u.fillColor && n.tspan.setAttributeNS(null, "fill", n.fillColor);
                        var A = n.textMatrix;
                        0 !== n.textRise && ((A = A.slice())[5] += n.textRise), n.txtElement.setAttributeNS(null, "transform", t(A) + " scale(1, -1)"), n.txtElement.setAttributeNS("http://www.w3.org/XML/1998/namespace", "xml:space", "preserve"), n.txtElement.appendChild(n.tspan), n.txtgrp.appendChild(n.txtElement), this._ensureTransformGroup().appendChild(n.txtElement)
                    }
                },
                setLeadingMoveText: function(e, t) {
                    this.setLeading(-t), this.moveText(e, t)
                ...
                fill: function() {
                    var e = this.current;
                    e.element && (e.element.setAttributeNS(null, "fill", e.fillColor), e.element.setAttributeNS(null, "fill-opacity", e.fillAlpha))
                },
                stroke: function() {
                    var t = this.current;
                ...
                paintInlineImageXObject: function(t, r) {
                    ...
                    l.setAttributeNS(n, "xlink:href", o), l.setAttributeNS(null, "x", "0"), l.setAttributeNS(null, "y", e(-a)), l.setAttributeNS(null, "width", e(i) + "px"), l.setAttributeNS(null, "height", e(a) + "px"), l.setAttributeNS(null, "transform", "scale(" + e(1 / i) + " " + e(-1 / a) + ")"), r ? r.appendChild(l) : this._ensureTransformGroup().appendChild(l)
                },
        ...
        var p = function() {
                function e(t) {
                    var r, n;
                    l(this, e), this.source = t, this.url = (r = t.url, "file:" === (n = d.parse(r)).protocol || n.host ? n : /^[a-z]:[/\\]/i.test(r) ? d.parse("file:///" + r) : (n.host || (n.protocol = "file:"), n)), this.isHttp = "http:" === this.url.protocol || "https:" === this.url.protocol, this.isFsUrl = "file:" === this.url.protocol, this.httpHeaders = this.isHttp && t.httpHeaders || {}, this._fullRequest = null, this._rangeRequestReaders = []
                }
                return n(e, [{
                    key: "getFullReader",
                    value: function() {
                        return (0, i.assert)(!this._fullRequest), this._fullRequest = this.isFsUrl ? new y(this) : new _(this), this._fullRequest
                    }
                }, {
                    key: "getRangeReader",
                    value: function(e, t) {
            ...
            v = function() {
                function e(t) {
                    l(this, e), this._url = t.url, this._done = !1, this._errored = !1, this._reason = null, this.onProgress = null, this._loaded = 0, this._readableStream = null, this._readCapability = (0, i.createPromiseCapability)();
                    var r = t.source;
        ...
        var _ = function(e) {
                    ...
                    var r = o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)),
                        n = function(t) {
                            ...
                            var n = function(e) {
                                ...
                                s = i.suggestedLength;
                            r._isRangeSupported = o, r._contentLength = s || r._contentLength, r._filename = (0, a.extractFilenameFromHeader)(n)
                        };
                    return r._request = null, "http:" === r._url.protocol ? r._request = c.request(g(r._url, e.httpHeaders), n) : r._request = h.request(g(r._url, e.httpHeaders), n), r._request.on("error", function(e) {
            ...
            b = function(e) {
                function t(e, r, n) {
                    ...
                    return i._httpHeaders.Range = "bytes=" + r + "-" + (n - 1), i._request = null, "http:" === i._url.protocol ? i._request = c.request(g(i._url, i._httpHeaders), function(e) {
                        i._setReadableStream(e)
                    }) : i._request = h.request(g(i._url, i._httpHeaders), function(e) {
                        i._setReadableStream(e)
            ...
            y = function(e) {
                function t(e) {
                    ...
                    return f.test(r._url.href) && (n = n.replace(/^\//, "")), u.lstat(n, function(e, t) {
                        if (e) return r._errored = !0, r._reason = e, void r._headersCapability.reject(e);
                        r._contentLength = t.size, r._setReadableStream(u.createReadStream(n)), r._headersCapability.resolve()
                    }), r
                }
                return s(t, m), t
            }(),
            A = function(e) {
                function t(e, r, n) {
                    ...
                    return f.test(i._url.href) && (a = a.replace(/^\//, "")), i._setReadableStream(u.createReadStream(a, {
                        start: r,
                        end: n - 1
                    })), i
                }
        ...
        t.getFilenameFromContentDispositionHeader = function(e) {
            ...
            if (r = function(e) {
                    ...
                    for (var f = [], p = 0; p < t.length && p in t; ++p) {
                        var m = n(t[p], 2),
                            v = m[0],
                            g = m[1];
                        g = u(g), v && (g = unescape(g), 0 === p && (g = c(g))), f.push(g)
                    }
                    return f.join("")
                }(e)) return l(h(r));
            ...
            function s(e, r) {
                if (e) {
                    ...
                    try {
                        for (var n = new TextDecoder(e, {
                                fatal: !0
                            }), i = new Array(r.length), a = 0; a < r.length; ++a) i[a] = r.charCodeAt(0);
                        r = n.decode(new Uint8Array(i)), t = !1
                    } catch (n) {
                        /^utf-?8$/i.test(e) && (r = decodeURIComponent(escape(r)), t = !1)
                    }
                }
                return r
            }
            ...
            function u(e) {
                if ('"' === e.charAt(0)) {
                    for (var t = e.slice(1).split('\\"'), r = 0; r < t.length; ++r) {
                        var n = t[r].indexOf('"'); - 1 !== n && (t[r] = t[r].slice(0, n), t.length = r + 1), t[r] = t[r].replace(/\\(.)/g, "$1")
                    }
                    e = t.join('"')
                }
                return e
        ...
        var l = function() {
                function e(t) {
                    o(this, e), this.source = t, this.isHttp = /^https?:/i.test(t.url), this.httpHeaders = this.isHttp && t.httpHeaders || {}, this._fullRequestReader = null, this._rangeRequestReaders = []
                }
                return n(e, [{
                    key: "getFullReader",
                    value: function() {
                        return (0, i.assert)(!this._fullRequestReader), this._fullRequestReader = new u(this), this._fullRequestReader
                    }
                }, {
                    key: "getRangeReader",
                    value: function(e, t) {
                ...
                function e(t) {
                    ...
                    fetch(c, s(this._headers, this._withCredentials)).then(function(e) {
                        ...
                        var t = function(t) {
                            ...
                            s = n.suggestedLength;
                        r._isRangeSupported = o, r._contentLength = s || r._contentLength, r._filename = (0, a.extractFilenameFromHeader)(t), !r._isStreamingSupported && r._isRangeSupported && r.cancel(new i.AbortException("streaming is disabled"))
                    ...
                    value: function() {
                        ...
                        return this._headersCapability.promise.then(function() {
                            return e._reader.read().then(function(t) {
                                ...
                                e._loaded += r.byteLength, e.onProgress && e.onProgress({
                                    loaded: e._loaded,
                                    total: e._contentLength
                                });
            ...
            c = function() {
                function e(t, r, n) {
                    var l = this;
                    o(this, e), this._stream = t, this._reader = null, this._loaded = 0;
                    var u = t.source;
                    for (var c in this._withCredentials = u.withCredentials, this._readCapability = (0, i.createPromiseCapability)(), this._isStreamingSupported = !u.disableStream, this._headers = new Headers, this._stream.httpHeaders) {
                    ...
                    var f = u.url;
                    fetch(f, s(this._headers, this._withCredentials)).then(function(e) {
                        if (!(0, a.validateResponseStatus)(e.status)) throw (0, a.createResponseStatusError)(e.status, f);
        ...
        function h(e) {
            this._source = e, this._manager = new l(e.url, {
        ...
        l.prototype = {
            ...
            request: function(e) {
                ...
                return c && !!e.onProgressiveData ? (t.responseType = "moz-chunked-arraybuffer", n.onProgressiveData = e.onProgressiveData, n.mozChunked = !0) : t.responseType = "arraybuffer", e.onError && (t.onerror = function(r) {
                    e.onError(t.status)
                    ...
                    if (n.readyState >= 2 && r.onHeadersReceived && (r.onHeadersReceived(), delete r.onHeadersReceived), 4 === n.readyState && e in this.pendingRequests)
                        if (delete this.pendingRequests[e], 0 === n.status && this.isHttp) r.onError && r.onError(n.status);
                            ...
                            if (200 === i && 206 === r.expectedStatus || i === r.expectedStatus) {
                                ...
                                } else r.onProgressiveData ? r.onDone(null) : a ? r.onDone({
                                    begin: 0,
                                    chunk: a
            ...
            getFullReader: function() {
                return (0, i.assert)(!this._fullRequestReader), this._fullRequestReader = new d(this._manager, this._source), this._fullRequestReader
            },
            getRangeReader: function(e, t) {
        ...
        }, t.PDFNetworkStream = h, t.NetworkManager = l
    }])
});
