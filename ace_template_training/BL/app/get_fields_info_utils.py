...
def needle_in_a_haystack(needle,haystack,proximity=None):
    ...
    for combo in all_combos:
        ...
        if match_score > 0.75:
            ...
            final_matches.append({'words':combo,'top':min_top,'y':min_top,'x':min_left,'left':min_left,'right':max_right,'bottom':max_bottom,'score':match_score,'area':area,'midpoint':midpoint})
