...
--
-- Database: `drl_business_rules`
--
CREATE DATABASE IF NOT EXISTS `drl_business_rules` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `drl_business_rules`;
