  ...
  function () {
    ...
    function MStepper(elem) {
      ...
      _defineProperty(this, "_methodsBindingManager", function (steps) {
        ...
        else nodesIterator(steps, function (step) {
      ...
      _defineProperty(this, "activateStep", function (elements, index) {
        ...
        if (typeof elements === 'string') {
          ...
          else nodesIterator(returnableElement, function (appendedElement) {
      ...
      _defineProperty(this, "deactivateStep", function (elements) {
        ...
        else if (elements instanceof HTMLCollection || elements instanceof NodeList) nodesIterator(elements, function (element) {
          return doIt(element);
